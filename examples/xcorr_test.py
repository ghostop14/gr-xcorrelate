...
class xcorr_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "xcorr_test")
        ...
        # Connections
        ##################################################
        self.msg_connect((self.xcorrelate_xcorrelate_0, 'corr'), (self.xcorrelate_ExtractDelay_0, 'corr'))
        ...
        self.connect((self.blocks_complex_to_mag_0, 0), (self.xcorrelate_xcorrelate_0, 0))
        self.connect((self.blocks_complex_to_mag_0_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.blocks_complex_to_mag_0_0, 0), (self.xcorrelate_xcorrelate_0, 1))
...
def main(top_block_cls=xcorr_test, options=None):
